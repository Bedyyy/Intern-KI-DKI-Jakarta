...
<body>
	<aside class="aside aside-fixed">
        <div class="aside-header">
            <a href="{{ url('/dashboard') }}" class="aside-logo pt-2">KIP_V3.2024</a>
        ...
        <div class="aside-body">
			<ul class="nav nav-aside">
				...
				<li class="nav-label mg-t-25">{{ __('ppid') }}</li>
				<li class="nav-item"><a href="{{ url('/dashboard/ppid/permohonaninformasi/table') }}" class="nav-link"><i data-feather="file-text"></i> <span>{{ __('general.permohonan_informasi') }}</span></a></li>
				<li class="nav-item"><a href="{{ url('/dashboard/ppid/keberataninformasi/table') }}" class="nav-link"><i data-feather="file-text"></i> <span>{{ __('general.keberatan_informasi') }}</span></a></li>
				<li class="nav-label mg-t-25">{{ __('general.bidang_psi') }}</li>
				<li class="nav-item"><a href="{{ url('#') }}" class="nav-link"><i data-feather="book-open"></i> <span>{{ __('general.registrasi_sengketa_informasi') }}</span></a></li>
				<li class="nav-item"><a href="{{ url('#') }}" class="nav-link"><i data-feather="folder-plus"></i> <span>{{ __('general.penetapan_sidang') }}</span></a></li>
				<li class="nav-item"><a href="{{ url('#') }}" class="nav-link"><i data-feather="bookmark"></i> <span>{{ __('general.surat_pemanggilan_sidang') }}</span></a></li>
				<li class="nav-item"><a href="{{ url('#') }}" class="nav-link"><i data-feather="message-square"></i> <span>{{ __('general.agenda_sidang') }}</span></a></li>
				<li class="nav-item"><a href="{{ url('#') }}" class="nav-link"><i data-feather="file-text"></i> <span>{{ __('general.putusan_sidang') }}</span></a></li>
				<li class="nav-item"><a href="{{ url('/dashboard/regulasi/table') }}" class="nav-link"><i data-feather="book"></i> <span>{{ __('general.regulasi') }}</span></a></li>

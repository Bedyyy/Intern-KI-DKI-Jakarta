@extends('layouts.app')
@section('title', __('regulasi.create_title'))
...
@section('content')
		...
		<div>
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb breadcrumb-style1 mg-b-10">
					...
					<li class="breadcrumb-item"><a href="{{ url('/dashboard/regulasi/table') }}">{{ __('general.posts') }}</a></li>
					<li class="breadcrumb-item active" aria-current="page">{{ __('regulasi.create_title') }}</li>
				</ol>
			</nav>
			<h4 class="mg-b-0 tx-spacing--1">{{ __('regulasi.create_title') }}</h4>
		</div>
	...
	<div class="card">
		{!! Form::open(['url' => '/dashboard/regulasi', 'class' => 'form-horizontal', 'method' => 'post', 'files' => true]) !!}
			<div class="card-body pd-b-0">
				...
				@include ('backend.regulasi.form', ['formMode' => 'create'])
			</div>

...
@section('content')
	...
	<div class="row">
		<div class="col-md-12 text-center">
			<p class="tx-color-03 tx-13">{{ getSetting('web_name') }} By {{ getSetting('web_author') }}.<br />&copy; Copyright 2017 - {{ date('Y') }}. Build with Laravel your Engine Management System.</p>
		</div>
	</div>
@endsection

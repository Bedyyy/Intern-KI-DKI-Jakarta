		...
		<div class="header-mid hidden-xs">
			<div class="container">
				<div class="row">
					<div class="col-sm-4">
						<div class="logo">
							<a href="{{ url('/') }}"><img src="{{ asset('po-content/uploads/'.getSetting('logo')) }}" class="img-responsive" width="80px" height="80px" alt=""></a>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-sm-4 footer-box">
					<div class="about-inner">
						<img src="{{ asset('po-content/uploads/'.getSetting('logo_footer')) }}" class="img-responsive" alt="" height="42" width="42"/>
